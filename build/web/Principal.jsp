<%-- 
    Document   : login
    Created on : 30-oct-2019, 20:23:21
    Author     : jesus
--%>
...
<html>
  ...
  <div class="dropdown-menu text-center">
    ...
    <a class="dropdown-item" href="login.jsp"><i class="fa fa-fw fa-times" ></i> salir</a>
           ...
           <img src="img/images.jpg" class="img-fluid" alt="Responsive image" width="100%"> 
  ...
  <div class="row">
    <div class="col-sm">
        <center> <img src="img/azucar.png" class="img-fluid" alt="Responsive image" > </center>
    </div>
    <div class="col-sm">
        <center><img src="img/azucar.png" class="img-fluid" alt="Responsive image" > </center>
    </div>
  ...
  <div class="row">
    <div class="col-sm">
        <center> <img src="img/naranja.JPG" class="img-fluid" alt="Responsive image" > </center>
    </div>
    <div class="col-sm">
        <center><img src="img/tomate.JPG" class="img-fluid" alt="Responsive image" > </center>
    </div>
    <div class="col-sm">
        <center><img src="img/zapallo.JPG" class="img-fluid" alt="Responsive image" > </center>
    </div>
  </div>
</div>
